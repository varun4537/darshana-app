 ...
 *
 * The backdrop + drawer panel are rendered via React Portal at
 * document.body so they escape any parent stacking contexts
 * (e.g. the nav bar's backdrop-blur creating a containing block).
 */
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.9)', zIndex: 9998 }}
                    />
