...
/**
 * Reusable Google sign-in button with error handling.
 * Extracted from splash-wall.tsx and login/page.tsx to avoid duplication.
 */
export function GoogleSignInButton({
    onSuccess,
}: {
    /** Optional callback after successful sign-in (e.g. redirect). */
    onSuccess?: () => void;
}) {
