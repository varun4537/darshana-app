...
export default function MeditationPage() {
    ...
    const { stats, isPremium, togglePremium } = useUserProgress();
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center py-12 px-6 relative overflow-hidden">
            ...
            >
                ...
                <button onClick={togglePremium} className="opacity-0 w-full h-2 cursor-default">Hack Premium Toggle</button>
            </motion.div>
